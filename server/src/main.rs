                ...
                reader.read_line(&mut input).await
            {
                ...
                if text.starts_with("/msg ") {
                    ...
                    if parts.len() == 3 {
                        ...
                        println!(
                            "Uso corretto: /msg <utente> <messaggio>"
                        );
                    }
                }
                ...
                // =================================================
                    ...
                    if parts.len() == 3 {
                        ...
                        if !found {
                            ...
                            println!(
                                "Utente {} non trovato tra gli utenti correnti.",
                                target_name
                            );
                        }
                ...
                // =================================================
                    ...
                    println!(
                        "Messaggio broadcast inviato a tutti"
                    );
                }
                    ...
                    Message::LogoutRequest {
                            ...
                            == Some(&user_id)
                        {
                            ...
                            let username = {
                                ...
                                //FIXME: l'utente che fa logout perde lo storico dei dati
                                w_state
                                    .clients
                                    .remove(&user_id)
                                    .map(
